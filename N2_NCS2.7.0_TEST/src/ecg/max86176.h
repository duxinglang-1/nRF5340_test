...
#define ECG_DEV DT_NODELABEL(spi3)
#else
...
#define ECG_PORT0 DT_NODELABEL(gpio0)
#else
#error "gpio0 devicetree node is disabled"
#define ECG_PORT0	""
#endif
#if DT_NODE_HAS_STATUS(DT_NODELABEL(gpio1), okay)
#define ECG_PORT1 DT_NODELABEL(gpio1)
#else
...
#define ECG_EN0_PIN			10	//给32674供电
#define ECG_EN1_PIN			19	//给86176供电
#define ECG_I2C_CON_PIN		8
#define ECG_SPI_CON_PIN		29
